...
abstract class DsTypography {
  ...
  static const TextStyle size11 = TextStyle(fontFamily: fontFamily, fontSize: 11, height: 1.273); // 14px line
  ...
  static const TextStyle size32 = TextStyle(fontFamily: fontFamily, fontSize: 32, height: 1.25);  // 40px line
  static const TextStyle size36 = TextStyle(fontFamily: fontFamily, fontSize: 36, height: 1.222);
  static const TextStyle size40 = TextStyle(fontFamily: fontFamily, fontSize: 40, height: 1.2);   // 48px line
  static const TextStyle size48 = TextStyle(fontFamily: fontFamily, fontSize: 48, height: 1.167);
  static const TextStyle size56 = TextStyle(fontFamily: fontFamily, fontSize: 56, height: 1.143); // 64px line
  ...
  static final TextStyle displayLg = size56.copyWith(fontWeight: FontWeight.w700, letterSpacing: -1.5);
  static final TextStyle displayMd = size48.copyWith(fontWeight: FontWeight.w700, letterSpacing: -1.0);
  static final TextStyle displaySm = size40.copyWith(fontWeight: FontWeight.w600, letterSpacing: -0.5);

  // ─── Semantic Aliases: Heading ────────────────────────────────────────
  static final TextStyle headingXl = size32.copyWith(fontWeight: FontWeight.w600, letterSpacing: -0.5);
  static final TextStyle headingLg = size24.copyWith(fontWeight: FontWeight.w600, letterSpacing: -0.3);
  static final TextStyle headingMd = size20.copyWith(fontWeight: FontWeight.w600, letterSpacing: -0.2);
  static final TextStyle headingSm = size18.copyWith(fontWeight: FontWeight.w600, letterSpacing: 0.0);

  // ─── Semantic Aliases: Body ───────────────────────────────────────────
  static final TextStyle bodyLg = size18.copyWith(fontWeight: FontWeight.w400, height: 28 / 18); // 28px line
  ...
  static final TextStyle labelSm   = size11.copyWith(fontWeight: FontWeight.w500, letterSpacing: 0.3);
  static final TextStyle caption   = size12.copyWith(fontWeight: FontWeight.w400);
  static final TextStyle overline  = size11.copyWith(fontWeight: FontWeight.w600, letterSpacing: 0.5, height: 16 / 11); // 16px line
}
